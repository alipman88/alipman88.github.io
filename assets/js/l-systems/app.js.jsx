      ...
      <div className="row">
        <div className="four columns">
          ...
          <div className="row">
            <div className="four columns">
              <label>Axiom</label>
              <input type="text" class="u-full-width" value={this.state.initial} onChange={this.changeInitial} />
            </div>

            <div className="four columns">
              <label>Angle</label>
              <input type="number" class="u-full-width" value={this.state.angle} min="0" max="360" onChange={this.changeAngle} />
            </div>

            <div className="four columns">
              <label>Iterations</label>
              <input type="number" class="u-full-width" value={this.state.iterations} min="0" max="16" onChange={this.changeIterations} />
            </div>
          </div>
          ...
          <div className="row" style={ {borderBottom: "1px solid #CCC"} }>
            <div className="twelve columns">
              <label>Rules</label>
              <textarea class="u-full-width" value={this.state.rules} onChange={this.changeRules} />
            </div>
          </div>
