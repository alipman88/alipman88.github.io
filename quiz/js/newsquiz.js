    ...
    $.quiz = function(quiz_data, options) {
        ...
        var quiz = {
            ...
            append_how_you_did_section: function() {
                ...
                var how_you_did_element = jQuery('<p class="how_you_did"><a style="position:absolute;right:100px;top:0px;" onclick="closeReveal()" href="javascript:void(0);">&#215;</a></p>');
            ...
            display_answer : function(question, question_index, answer) {
                ...
                if (question_index == self.quiz_data.length - 1) {
                    // action when user answers last question
                    $('.how_you_did').animate({bottom:'400px'});
                }
            },
...
function closeReveal() {
    // execute after user clicks close button
    $('.how_you_did').animate({bottom:'40px'});
}
